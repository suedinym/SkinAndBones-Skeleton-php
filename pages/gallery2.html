...
<head>
  ...
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
	<meta charset="utf-8">
	<title>Gallery | 2 images per row</title>
...
<body>
  ...
  <li><a href="gallery4.html">Gallery 4</a></li>
    ...
    ================================================== -->
				<h3 class="modal-head centertxt">Skull</h3><!-- modal one --><a href="#openModal1"><img class="open-modal-gal2" src="../images/icons/enlarge.svg"></a> <img class="gal2" src="../images/gallery/image3.png"></div><!-- The Modal -->
				<!-- note: id is anchor  -->
